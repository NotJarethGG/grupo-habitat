...
const links = [
  { label: 'Servicios', href: '#servicios-aire' },
  { label: 'Marcas', href: '#marcas' },
  { label: 'Cobertura', href: '#cobertura' },
]

const sectionIds = ['servicios-aire', 'marcas', 'cobertura', 'contacto-aire']

export default function NavbarAireAcondicionado() {
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            {links.map((link) => (
              ...
              >
                {link.label}
                <span
                  className={`absolute bottom-0 left-3 right-3 h-0.5 bg-gray-900 transition-transform duration-300 origin-left rounded-full ${
